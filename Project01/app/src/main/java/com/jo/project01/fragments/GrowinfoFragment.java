...
public class GrowinfoFragment extends Fragment{
    ...
    private void makeView(){
        ((Button)wholeView.findViewById(R.id.button_graph)).setOnClickListener(click);
    ...
    View.OnClickListener click = new View.OnClickListener(){
        ...
        public void onClick(View v){
            ...
            if(id == R.id.button_graph);
            else if(id == R.id.button_develop);
            else if(id == R.id.button_expect);
        }
